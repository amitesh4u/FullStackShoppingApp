...
const PageHeaderMessageComponent = (props) => {
  if (props.type === 'ERROR') {
    return (<p className="mx-lg-4 mt-3 py-1 bg-danger-subtle">
    ...
    return (<p className="mx-lg-4 mt-3 py-1 bg-success-subtle">
              <span className="text-black mx-lg-4 fs-5">
    ...
    return (<p className="mx-lg-4 mt-3 py-1 bg-warning-subtle">
              <span className="text-black mx-lg-4 fs-5">

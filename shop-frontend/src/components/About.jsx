      ...
      <div className="card col-md-8 offset-md-2">
        ...
        <div className="">
          ...
          <ul className="fs-6">
            ...
            <li><b>AssertJ</b> - Simple assertion style while Unit testing</li>
            <li><b>Lombok</b> - Auto generates boilerplate code for POJOs</li>
            <li><b>Hibernate/Spring Data JPA</b> - Persistence Implementation
              Framework
            </li>
            <li><b>TestContainers</b> - A framework that allows us to launch a MySQL
            ...
            <li><b>Static Code Analysis</b> - By SpotBugs, PMD, Google Checkstyle (If
              using Sonar then not req as most of the rules are now part of
              Sonar)
            </li>
            <li><b>Slf4j/CustomLog</b> - Slf4j Logging support using Lombok CustomLog</li>
            <li><b>Swagger</b> - OpenAPI which is the version 3 implementation for
              Spring Boot 3.x
            </li>
